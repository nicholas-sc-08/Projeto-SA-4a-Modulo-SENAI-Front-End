...
export default function Inicio_dashboard() {
    ...
    return (
        <div>
            ...
            <h1 className={styles['saudacoes_ao_admin']}>Olá Administrador(a)!</h1>

            <div className={styles["container_alinhamento_botoes_dashboard"]}>

                <div className={styles["dashboard_container_brechos"]} onClick={ir_para_brechos} onMouseLeave={() => set_mudar_icone_brecho(false)} onMouseEnter={() => set_mudar_icone_brecho(true)}>

                    <div className={styles["sombra_dashboard_container_brechos"]}>

                        <div className={styles['dashboard_container_brechos_borda']}>
                            <div className={styles['dashboard_container_brechos_img']}>

                                <svg width="100%" height="100%" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M34.1416 5H27.4883L28.3216 13.3333C28.3216 13.3333 29.9883 15 32.4883 15C33.8006 15.0017 35.0684 14.524 36.0533 13.6567C36.1574 13.5594 36.235 13.4372 36.2787 13.3016C36.3224 13.166 36.3309 13.0214 36.3033 12.8817L35.1266 5.83333C35.0873 5.60049 34.9668 5.38909 34.7865 5.23656C34.6062 5.08404 34.3778 5.00024 34.1416 5V5Z" stroke={cor_icone_brecho} strokeWidth="2" />
                                    <path d="M27.4883 5L28.3216 13.3333C28.3216 13.3333 26.6549 15 24.1549 15C21.6549 15 19.9883 13.3333 19.9883 13.3333V5H27.4883Z" stroke={cor_icone_brecho} strokeWidth="2" />
                                    <path d="M19.9896 5V13.3333C19.9896 13.3333 18.3229 15 15.8229 15C13.3229 15 11.6562 13.3333 11.6562 13.3333L12.4896 5H19.9896Z" stroke={cor_icone_brecho} strokeWidth="2" />
                                    <path d="M12.4892 5H5.83758C5.60091 4.99991 5.37187 5.08377 5.19121 5.23666C5.01054 5.38955 4.88997 5.60157 4.85091 5.835L3.67591 12.8833C3.64845 13.0231 3.65699 13.1676 3.70072 13.3032C3.74445 13.4387 3.82195 13.5609 3.92591 13.6583C4.47258 14.1417 5.69425 15.0017 7.48925 15.0017C9.98925 15.0017 11.6559 13.335 11.6559 13.335L12.4892 5.00167V5Z" stroke={cor_icone_brecho} strokeWidth="2" />
                                    <path d="M5 15V31.6667C5 32.5507 5.35119 33.3986 5.97631 34.0237C6.60143 34.6488 7.44928 35 8.33333 35H31.6667C32.5507 35 33.3986 34.6488 34.0237 34.0237C34.6488 33.3986 35 32.5507 35 31.6667V15" stroke={cor_icone_brecho} strokeWidth="2" />
                                    <path d="M24.7227 34.9993V24.9993C24.7227 24.1153 24.3715 23.2674 23.7463 22.6423C23.1212 22.0172 22.2734 21.666 21.3893 21.666H18.056C17.1719 21.666 16.3241 22.0172 15.699 22.6423C15.0738 23.2674 14.7227 24.1153 14.7227 24.9993V34.9993" stroke={cor_icone_brecho} strokeWidth="2" strokeMiterlimit={16} />
                                </svg>
                    ...
                    <motion.pre className={styles['quantidade_de_brechos']}>{arredondar_valor_brechos}</motion.pre>
                    <span>Brechós</span>

                </div>

                <div className={styles["dashboard_container_clientes"]} onClick={ir_para_clientes} onMouseEnter={() => set_caminho_imagem_clientes(`./img/icons/icone_dashboard_clientes_v_dois.svg`)} onMouseLeave={() => set_caminho_imagem_clientes(`./img/icons/icone_dashboard_clientes_v_um.svg`)}>

                    <div className={styles["sombra_dashboard_container_clientes"]}>

                        <div className={styles['dashboard_container_clientes_borda']}>
                            <div className={styles['dashboard_container_clientes_img']}>
                    ...
                    <motion.pre className={styles['quantidade_de_clientes']}>{arredondar_valor_clientes}</motion.pre>
                    <span>Clientes</span>

                </div>

                <div className={styles["dashboard_container_produtos"]} onClick={ir_para_produtos} onMouseLeave={() => set_mudar_icone_produtos(false)} onMouseEnter={() => set_mudar_icone_produtos(true)}>

                    <div className={styles["sombra_dashboard_container_produtos"]}>

                        <div className={styles['dashboard_container_produtos_borda']}>

                            <div className={styles['dashboard_container_produtos_img']}>
                    ...
                    <motion.pre className={styles['quantidade_de_produtos']}>{arredondar_valor_produtos}</motion.pre>
                    <span>Produtos</span>

                </div>

                <div className={styles["dashboard_container_categorias"]} onClick={ir_para_categorias} onMouseEnter={() => set_caminho_imagem_categorias(`./img/icons/icone_dashboard_etiqueta_v_dois.svg`)} onMouseLeave={() => set_caminho_imagem_categorias(`./img/icons/icone_dashboard_etiqueta_v_um.svg`)}>

                    <div className={styles["sombra_dashboard_container_categorias"]}>

                        <div className={styles['dashboard_container_categorias_borda']}>
                            <div className={styles['dashboard_container_categorias_img']}>
                    ...
                    <motion.pre className={styles['quantidade_de_categorias']}>{arredondar_valor_categorias}</motion.pre>
                    <span>Categorias</span>

                </div>

                <div className={styles["dashboard_container_categorias"]} onClick={ir_para_marcas} onMouseEnter={() => set_caminho_imagem_marca(`./img/icons/marcas-icon-verde.svg`)} onMouseLeave={() => set_caminho_imagem_marca(`./img/icons/marcas-icon-branco.svg`)}>

                    <div className={styles["sombra_dashboard_container_categorias"]}>

                        <div className={styles['dashboard_container_categorias_borda']}>
                            <div className={styles['dashboard_container_marcas_img']}>
                    ...
                    <motion.pre className={styles['quantidade_de_categorias']}>{arredondar_valor_marcas}</motion.pre>
                    <span>Marcas</span>
