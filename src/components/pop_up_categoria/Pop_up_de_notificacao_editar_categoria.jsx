...
import styles from "@/components/pop_up_categoria/Pop_up_de_notificacao_editar_categoria.module.css";

export default function Pop_up_de_notificacao_editar_categoria() {
    return (
