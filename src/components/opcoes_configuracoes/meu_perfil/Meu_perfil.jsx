...
//     const [tipoUsuario, setTipoUsuario] = useState(null) // 'cliente' ou 'brecho'
...
//     // Identificar tipo de usuário e buscar dados
//     useEffect(() => {
...
//                     dadosParaAtualizar.data_de_nascimento = new Date(dadosPessoais.data_de_nascimento)
//                 }
//             } else {
...
//                     dadosParaAtualizar.data_de_nascimento_vendedor = new Date(dadosPessoais.data_de_nascimento_vendedor)
//                 }
//             }
...
//     const formatarCPF = () => {
//         return '•••.•••.•••-••' // CPF criptografado, não deve ser exibido
//     }
...
//             {/* Dados do brechó - só aparece se for brechó */}
//             {tipoUsuario === 'brecho' && (
//                 <div className={styles['container-secoes-dados']}>
//                     <div className={styles["container-alinhamento-titulo"]}>
    ...
    const handleSalvarDadosPessoais = async () => {
        try {
            ...
            if (tipoUsuario === 'cliente') {
                ...
                if (dadosPessoais.data_de_nascimento_vendedor) {
                    dadosParaAtualizar.data_de_nascimento_vendedor = dadosPessoais.data_de_nascimento_vendedor
                }
            }
