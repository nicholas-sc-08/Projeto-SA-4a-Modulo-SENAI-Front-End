...
import styles from '@/components/filtro_de_pesquisa/Filtro_de_pesquisa.module.css';

export default function Filtro_de_pesquisa() {
    ...
    return (
        <div className={styles["container_filtro_de_pesquisa"]}>

            <div className={styles["container_titulo_filtro_de_pesquisa"]}>
            ...
            <div className={styles["container_pesquisa_por_categoria"]}>

                <div className={styles["container_pesquisa_filtro_um"]}>
                ...
                {exibir_filtro_um &&
                    ...
                    <div className={styles["container_resultado_pesquisa_filtro_um"]}>
                ...
                <div className={styles["container_pesquisa_filtro_dois"]}>
                ...
                {exibir_filtro_dois &&
                    ...
                    <div className={styles["container_resultado_pesquisa_filtro_dois"]}>
                ...
                <div className={styles["container_pesquisa_filtro_tres"]}>
                ...
                {exibir_filtro_tres &&
                    ...
                    <div className={styles["container_resultado_pesquisa_filtro_tres"]}>
            ...
            <div className={styles["container_preco_titulo_filtro_de_pesquisa"]}>

                <h1>Preços</h1>

            </div>

            <div className={styles["container_preco_filtro_de_pesquisa"]}>

                <div className={styles["container_selecionar_preco_filtro_de_pesquisa"]}>
                    ...
                    <div className={styles["container_exibir_preco_filtro_de_pesquisa"]}>
            ...
            <div className={styles["container_tamanho_titulo_filtro_de_pesquisa"]}>

                <h1>Tamanhos</h1>

            </div>

            <div className={styles["container_tamanho_filtro_de_pesquisa"]}>

                <div className={styles["container_selecionar_tamanho_filtro_de_pesquisa"]}>

                    {array_de_tamanhos_de_roupa.map((tamanho, i) => (

                        <div key={i} className={filtro_de_pesquisa.tamanhos.includes(tamanho) ? styles[`container_botao_selecionado_filtro`] : styles[`container_botao_filtro`]}>
            ...
            <div className={styles["container_titulo_estilos"]}>

                <h1>Estilos</h1>

            </div>

            <div className={styles["container_pesquisa_por_estilos"]}>

                <div className={styles["container_pesquisa_por_estilo_um"]}>
                ...
                {exibir_estilo_um &&
                    ...
                    <div className={styles["container_resultado_pesquisa_estilo_um"]}>
                ...
                <div className={styles["container_pesquisa_por_estilo_dois"]}>
                ...
                {exibir_estilo_dois &&
                    ...
                    <div className={styles["container_resultado_pesquisa_estilo_dois"]}>
                ...
                <div className={styles["container_pesquisa_por_estilo_tres"]}>
                ...
                {exibir_estilo_tres &&
                    ...
                    <div className={styles["container_resultado_pesquisa_estilo_tres"]}>
            ...
            <div className={styles["container_botao_filtro_de_pesquisa"]}>

                <button className={styles['botao_filtro_de_pesquisa_limpar']} onClick={() => limpar_filtro_de_pesquisa()}>Limpar</button>
                <button className={styles['botao_filtro_de_pesquisa_aplicar']} onClick={() => aplicar_filtro()}>Aplicar Filtro</button>
