...
export default function Sacola_geral() {
    ...
    return (
        <AnimatePresence>
            <motion.div
                className={styles["container_sacola_geral"]}
            ...
            >
                ...
                <div className={styles["alinhamento_conteudo_tela_sacola_geral"]} ref={referencia_sacola}>

                    <h1 className={styles['titulo_tela_sacola']}>Sacola</h1>

                    <div className={styles["container_conteudo_sacola_geral"]}>

                        <div className={styles["container_produtos_na_sacola_geral"]}>
                            ...
                            {sacola && sacola.length > 0 ? sacola.map((produto_sacola, i) => (
                                        ...
                                        <div className={styles["container_preco_produto_sacola_geral"]}>
                                            ...
                                            <div className={styles["container_contador_quantidade_produtos"]}>
                                                ...
                                                <button
                                                    ...
                                                    className={styles['botao_aumentar_contador_sacola_geral']}
                                                    onClick={e => {
                                                        e.stopPropagation();
                                ...
                                <div className={styles['container_nenhum_item_sacola_geral']}>
                        ...
                        <div className={styles["container_resumo_do_pedido_sacola_geral"]}>

                            <h3>Resumo do Pedido</h3>

                            <div className={styles["container_texto_do_resumo_pedido"]}>
                            ...
                            <div className={styles["container_valores_sacola_geral"]}>

                                <div className={styles["container_sub_total_sacola_geral"]}>
                                    <span>Subtotal</span>
                                    <span>{preco_total_dos_produtos()}</span>
                                </div>

                                <div className={styles["container_total_sacola_geral"]}>
                                    <span>Total</span>
                                    <span>{preco_total_dos_produtos()}</span>
                                </div>

                                <div className={styles["container_botao_de_finalizar_compra"]}>
