...
function page() {
    ...
    const criar_objeto_pedido = () => {
        ...
        const objeto_pedido = {
            ...
            valor: produto_atual.preco * quantidade,
    ...
    const enviar_pedido = () => {
        ...
        if (!pedido.material || !pedido.padrao || !pedido.tamanho) {
            alert('Por favor, selecione todas as opções obrigatórias (material, padrão e tamanho)');
            return;
        }

        console.log('Objeto para enviar ao backend:', pedido);
